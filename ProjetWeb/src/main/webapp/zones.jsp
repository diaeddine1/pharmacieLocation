				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light"></span> Gestion Des Zones
						</h4>
							...
							<div class="col-xxl">
								<div class="card mb-4">
									<div
										...
										<h5 class="mb-0">Ajouter Des Zones</h5>

									</div>
									<div class="card-body">
										<form name="formville" action="ZoneController" method="get">
											<div class="row mb-3">
											...
											<div class="row mb-3">
												...
												<div class="col-sm-10">
													<select class="form-select" id="ville"
														...
														<%
														VilleService s = new VilleService();
														for (Ville v : s.findAll()) {
														%>
								...
								<div class="card">
									<h5 class="card-header">List Des Zones</h5>
									<div class="table-responsive text-nowrap">
										<table class="table">
											...
											<tbody>
												...
												for (Zone v : zs.findAll()) {
												%>
												<tr>
													<td scope="row"><%=v.getId()%></td>
													<td><%=v.getNom()%></td>
													<td><%=v.getVille().getNome()%></td>
													<td>
														<div class="dropdown">
															<button type="button"
															...
															<div class="dropdown-menu">
																<a class="dropdown-item"
																	onclick="recoverInfo(<%=v.getId()%>,'<%= v.getNom() %>','<%=v.getVille().getId()%>');"><i
																	class="bx bx-edit-alt me-1"></i> Edit</a> <a
																	class="dropdown-item"
																	href="ZoneController?id=<%=v.getId()%>&op=delete"><i
