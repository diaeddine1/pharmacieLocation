			...
			<div class="authentication-inner">
				...
				<div class="card">
					<div class="card-body">
						...
						<p class="mb-4">Créez votre compte pour utiliser l'application</p>

						<form id="formAuthentication" class="mb-3"
							action="RegisterController" method="POST">
							<div class="mb-3">
								<label for="username" class="form-label">Prenom</label> <input
									type="text" class="form-control" id="prenom" name="prenom"
									placeholder="Entrez votre prenom " autofocus />
							</div>
							<div class="mb-3">
								<label for="email" class="form-label">Nom</label> <input
							...
							<div class="mb-3">
								<label for="email" class="form-label">Telephone</label> <input
						...
						<p class="text-center">
							<span>Vous avez déjà un compte?</span> <a href="Auth.jsp"> <span>Connectez-vous</span>
							</a>
						</p>
					</div>
				</div>
